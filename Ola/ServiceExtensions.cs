...
namespace Ola
{
    ...
    public static class ServiceExtensions
    {
        ...
        public static IOlaBuilder AddOla(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            var builder = new OlaBuilder(services, configuration);
            BuildServices(builder, exportedTypes);
            return builder;
        }

        private static void BuildServices(IOlaBuilder builder, IEnumerable<Type> exportedTypes)
        {
        ...
        public static IApplicationBuilder UseOla(this IApplicationBuilder app, IConfiguration configuration)
        {
