...
namespace Ola.Data.Query.Translators.Internal
{
    /// <summary>
    /// String.Concat方法。
    /// </summary>
    public class StringConcatTranslator : IExpressionFragmentTranslator
    {
        ...
        {
            return expression is ConstantExpression constantExpression && constantExpression.Type == typeof(object) && constantExpression.Value != null
