...
using Ola.Data;
using IDbTransaction = Ola.Data.Internal.IDbTransaction;
...
namespace Ola.Extensions
{
    ...
    public abstract class Database : IDatabase
    {
        ...
        public virtual bool BeginTransaction(Func<Data.Internal.IDbTransaction, bool> executor, int timeout = 30)
        {
            using var connection = GetConnection();
            connection.Open();
        ...
        /// <returns>返回事务实例对象。</returns>
        public virtual async Task<bool> BeginTransactionAsync(Func<Data.Internal.IDbTransaction, Task<bool>> executor, int timeout = 30, CancellationToken cancellationToken = default)
        {
            await using var connection = GetConnection();
