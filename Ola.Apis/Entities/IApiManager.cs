...
namespace Ola.Apis.Entities
{
    ...
    public interface IApiManager : ISingletonService
    {
        ...
        IEnumerable<ApiService> LoadApis(int categoryId = 0);
        ...
        /// <param name="categoryId">分类Id。</param>
        /// <returns>返回当前类型的API列表。</returns>
        Task<IEnumerable<ApiService>> LoadApisAsync(int categoryId = 0);
        ...
        IEnumerable<ApiService> LoadApplicationApis(int applicationId);
        ...
        /// <param name="applicationId">应用程序Id。</param>
        /// <returns>返回当前应用程序的API列表。</returns>
        Task<IEnumerable<ApiService>> LoadApplicationApisAsync(int applicationId);
